...
const PAIRS = [
  ...
  { a: 'Filet Mignon', b: 'Chocolate Cake',
    note: "After the filet, the chocolate cake -- the lean butter-tender 6oz hands off to layered cocoa-and-ganache weight, and the vanilla ice cream lifts the close back to the filet's restraint. Works; clean transition from the meal's lighter steak into the richer close.",
    tier: 'works' },
  { a: 'Filet Mignon', b: 'Chocolate Brownie',
    note: "The filet closes with the warm fudge brownie -- the butter-tender 6oz gives way to dense cocoa fudge, and the warm vanilla ice cream lifts the close. Works; a substantial finish to a restrained main.",
    tier: 'works' },
  ...
  { a: 'Filet Mignon', b: 'Mocha Creme',
    note: "The filet into the mocha creme -- the butter-tender 6oz hands off to silky coffee-chocolate cream, espresso depth closing the meal cleanly. Strong; the lighter steak meets the layered dessert at register.",
    tier: 'strong' },
  ...
  { a: 'Filet Mignon', b: 'Cheesecake',
    note: "The filet closes with the cheesecake -- the butter-tender 6oz hands off to dense cream-cheese custard on graham crust, berry compote brightening the close. Works; a heavier close than the steak called for, but it lands cleanly.",
    tier: 'works' },
  ...
  { a: 'Filet Mignon', b: 'Carrot Cake',
    note: "The filet into the carrot cake -- the butter-tender 6oz yields to spiced cake and cream-cheese frosting, walnut adding crunch on the close. Works; the spice-and-frosting weight outsizes the steak, but the table builds cleanly across courses.",
    tier: 'works' },
  ...
  // ── THE TOMAHAWK (40oz theatrical bone-in) ───────────────────────────
  { a: 'The Tomahawk', b: 'Chocolate Cake',
    note: "After the Tomahawk, the chocolate cake -- the 40oz long-bone showpiece hands off to layered cocoa-and-ganache, the vanilla scoop closing the table. Excellent; the headline cut earns the layered chocolate close.",
    tier: 'excellent' },
  ...
  { a: 'The Tomahawk', b: 'Peanut Butter Brownie',
    note: "After the Tomahawk, the PB brownie -- the 40oz cut yields to peanut-and-chocolate fudge, vanilla ice cream tempering the heat. Strong; the headline steak meets the substantial close.",
    tier: 'strong' },
  ...
  { a: 'The Tomahawk', b: 'Creme Brulee',
    note: "After the Tomahawk, the brulee -- the 40oz showpiece yields to vanilla-bean custard and torched-sugar crust, berries brightening the close. Strong; the theatrical steak earns the steakhouse classic close.",
    tier: 'strong' },
