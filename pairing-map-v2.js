...
const PAIRING_MAP = [
...

  {
    ...
    strong: ['Silver Oak Cabernet Sauvignon','Lingua Franca Avni Pinot Noir','Creamed Spinach','Shrimp Bisque','The Manhattan','Frias Block 5','Lail Vineyards Blueprint','Château Gombaude-Guillot','Fattoria Le Pupille Saffredi'],
    works: ['Quilt Cabernet Sauvignon','Faust Napa Valley Cabernet','House Wedge','Château de Rouillac','Au Gratin Potatoes','Mushrooms','Creme Brulee','Cheesecake','Beignets','Carrot Cake','Chocolate Brownie','Peanut Butter Brownie','Venge Scout\'s Honor'],
  ...
  },
  {
    ...
    excellent: ['Caymus Cabernet Sauvignon','Jordan Cabernet Sauvignon','Far Niente Cabernet Sauvignon','Evening Land Seven Springs','Scavino Barolo','Escargot Butter','Truffle Fries','Lobster Mac'],
    strong: ['Silver Oak Cabernet Sauvignon','Lingua Franca Avni Pinot Noir','Creamed Spinach','Shrimp Bisque','The Manhattan','Bowdie\'s Old Fashioned','Frias Block 5','Château Gombaude-Guillot','Fattoria Le Pupille Saffredi'],
  ...
  },
  {
    ...
    strong: ['Ghost Block Cabernet Sauvignon','Austin Hope Cabernet Sauvignon','Peju Cabernet Sauvignon','Lingua Franca Avni Pinot Noir','Creamed Spinach','Truffle Fries','Venge Scout\'s Honor','Fattoria Le Pupille Saffredi','Château Gombaude-Guillot'],
  ...
  },
  {
    ...
    excellent: ['Silver Oak Cabernet Sauvignon','Shafer Hillside Select','Opus One','Scavino Barolo','Darioush Cabernet Sauvignon','Bowdie\'s Old Fashioned','Espresso Old Fashioned','Fattoria Le Pupille Saffredi'],
    strong: ['Caymus Cabernet Sauvignon','Ghost Block Cabernet Sauvignon','Nickel & Nickel Cabernet','Creamed Spinach','Brussels and Belly','Venge Silencieux','Venge Scout\'s Honor'],
    works: ['Jordan Cabernet Sauvignon','Faust Napa Valley Cabernet','House Wedge','Marimar Estate Christina','Truffle Fries','Chocolate Brownie','Peanut Butter Brownie','Cheesecake','Creme Brulee','Carrot Cake','Beignets','Château Gombaude-Guillot'],
  ...
  },
  {
    ...
    strong: ['Darioush Cabernet Sauvignon','Silver Oak Cabernet Sauvignon','Venge Family Reserve','Lail Vineyards Blueprint','Creamed Spinach','Brussels and Belly','Fattoria Le Pupille Saffredi','Venge Scout\'s Honor'],
  ...
  },
  {
    ...
    strong: ['Ghost Block Cabernet Sauvignon','Lail Vineyards Blueprint','Far Niente Cabernet Sauvignon','Brussels and Belly','Bowdie\'s Old Fashioned','Lobster Mac','Fattoria Le Pupille Saffredi','Venge Scout\'s Honor','Château Gombaude-Guillot'],
  ...
  },
  {
    ...
    strong: ['Silver Oak Cabernet Sauvignon','Ghost Block Cabernet Sauvignon','Venge Silencieux','Brussels and Belly','Creamed Spinach','Fattoria Le Pupille Saffredi','Venge Scout\'s Honor'],
    works: ['Jordan Cabernet Sauvignon','Faust Napa Valley Cabernet','House Wedge','Chocolate Brownie','Peanut Butter Brownie','Cheesecake','Château Gombaude-Guillot'],
...

  {
    ...
    strong: ['Far Niente Cabernet Sauvignon','Ghost Block Cabernet Sauvignon','Vieux Carré','Not a Paper Plane','Mushrooms','Château Gombaude-Guillot'],
    works: ['Lingua Franca Avni Pinot Noir','Evening Land Seven Springs','Espresso Old Fashioned','Venge Scout\'s Honor','Fattoria Le Pupille Saffredi'],
  ...
  },
  {
    ...
    strong: ['Jean-Pierre Grossot Chablis','Elk Cove Pinot Blanc','Lingua Franca Avni Pinot Noir','Raventós Cava de NIT Rosé Brut','The Manhattan','Château Gombaude-Guillot'],
  ...
  },
  {
    ...
    strong: ['Far Niente Cabernet Sauvignon','Ghost Block Cabernet Sauvignon','Lingua Franca Avni Pinot Noir','Not a Paper Plane','Vieux Carré','Negroni','Fattoria Le Pupille Saffredi'],
    works: ['Evening Land Seven Springs','Faust Napa Valley Cabernet','Truffle Fries','Château Gombaude-Guillot','Venge Scout\'s Honor'],
    avoid: ['G.D. Vajra Moscato d\'Asti','Laurent Perrier Le Cuvée Brut','Stoneleigh Sauvignon Blanc','Head Fake','Paloma']
  },
  {
  ...
  },
  {
    ...
    excellent: ['Cowboy Ribeye','The Tomahawk','Bone Marrow','Kansas City','Porterhouse'],
    strong: ['Bone-In Filet','Filet Mignon','Brussels and Belly','Creamed Spinach','Mushrooms','Lardons'],
    works: ['Truffle Fries','Au Gratin Potatoes','Prime Tartare','Lobster Mac'],
  ...
  },
  {
    ...
    excellent: ['Filet Mignon','Bone-In Filet','Mushrooms','Truffle Fries','Lobster Mac','Escargot Butter'],
    strong: ['Bone Marrow','Kansas City','Porterhouse','Creamed Spinach','Au Gratin Potatoes','Shrimp Bisque'],
    works: ['Cowboy Ribeye','House Wedge','Grilled Caesar','Brussels and Belly'],
    avoid: ['Crab Cake','Seared Scallops','Burrata','Shrimp Cocktail','Stoneleigh Sauvignon Blanc','G.D. Vajra Moscato d\'Asti']
  },
  {
  ...
  },
  {
    ...
    strong: ['The Tomahawk','Porterhouse','Brussels and Belly','Creamed Spinach','Lardons'],
    works: ['Filet Mignon','House Wedge','Au Gratin Potatoes','Grilled Caesar'],
    avoid: ['Crab Cake','Seared Scallops','Burrata','Shrimp Cocktail','Faroe Island Salmon']
  },
  {
  ...
  },
  {
    ...
    category: 'tequila',
    spiritCluster: true,
    members: ['Don Julio Reposado','Don Julio 70th','El Mayor Reposado','Milagro Reposado','Siete Leguas Reposado','Corazon Reposado','Don Fulano Reposado','Adictivo Reposado','El Cabo','G4 High Proof','Trombo Cedano Reposado','Komos Rosa Reposado','Codigo 1530 Rosa','Clase Azul Reposado'],
